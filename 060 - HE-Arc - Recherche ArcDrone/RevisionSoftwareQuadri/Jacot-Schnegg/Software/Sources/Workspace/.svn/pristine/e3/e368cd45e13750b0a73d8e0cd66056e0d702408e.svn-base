...
{
	// Vector table base address configuration  
...
void isrINT_HardFault(void)
{
  /* Write your interrupt code here ... */

}
/* end of isrINT_HardFault */

void isrINT_MemFault(void)
{
  /* Write your interrupt code here ... */

}
/* end of isrINT_MemFault */

void isrINT_BusFault(void)
{
  /* Write your interrupt code here ... */

}
/* end of isrINT_BusFault */

void isrINT_UsageFault(void)
{
  /* Write your interrupt code here ... */

}
/* end of isrINT_UsageFault */

void isrINT_SVCall(void)
{
  /* Write your interrupt code here ... */

}
/* end of isrINT_SVCall */

void isrINT_DebugMon(void)
{
  /* Write your interrupt code here ... */

}
/* end of isrINT_DebugMon */

void isrINT_SysTick(void)
{
  /* Write your interrupt code here ... */

}
/* end of isrINT_SysTick */
...
static __declspec(vectortable) tVectorTable __vect_table = { /* Interrupt vector table */
   __SP_INIT,                                              /* 0 (0x00000000) (prior: -) */
  {
   ...
   (tIsrFunc)isrINT_HardFault,                             /* 3 (0x0000000C) (prior: -1) */
   (tIsrFunc)isrINT_MemFault,                              /* 4 (0x00000010) (prior: -) */
   (tIsrFunc)isrINT_BusFault,                              /* 5 (0x00000014) (prior: -) */
   (tIsrFunc)isrINT_UsageFault,                            /* 6 (0x00000018) (prior: -) */
   ...
   (tIsrFunc)isrINT_SVCall,                                /* 11 (0x0000002C) (prior: -) */
   (tIsrFunc)isrINT_DebugMon,                              /* 12 (0x00000030) (prior: -) */
   (tIsrFunc)UNASSIGNED_ISR,                               /* 13 (0x00000034) (prior: -) */
   (tIsrFunc)UNASSIGNED_ISR,                               /* 14 (0x00000038) (prior: -) */
   (tIsrFunc)isrINT_SysTick,                               /* 15 (0x0000003C) (prior: -) */
   ...
   (tIsrFunc)iUart0_INTRx,                               /* 61 (0x000000F4) (prior: -) */
   ...
   (tIsrFunc)iFlextimer_INTFTM0,                               /* 78 (0x00000138) (prior: -) */
   (tIsrFunc)iFlextimer_INTFTM1,                               /* 79 (0x0000013C) (prior: -) */
   (tIsrFunc)iFlextimer_INTFTM2,                               /* 80 (0x00000140) (prior: -) */
   ...
   (tIsrFunc)iPit_INTPit0,                                 /* 84 (0x00000150) (prior: -) */
   (tIsrFunc)iPit_INTPit1,                               /* 85 (0x00000154) (prior: -) */
   (tIsrFunc)iPit_INTPit2,                               /* 86 (0x00000158) (prior: -) */
   (tIsrFunc)iPit_INTPit3,                               /* 87 (0x0000015C) (prior: -) */
