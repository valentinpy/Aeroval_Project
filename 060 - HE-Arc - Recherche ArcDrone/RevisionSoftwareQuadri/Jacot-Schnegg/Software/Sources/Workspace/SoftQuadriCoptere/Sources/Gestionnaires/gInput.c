...
{
	// Accéléromètre
	if(mCapteurAccelMagn_ReadAllAccelAxes(gInput.captAccelData))
	{
		gInput.captAccelOK = true;
	}
	
	// Magnétomètre
	if(mCapteurAccelMagn_ReadAllMagnAxes(gInput.captMagnData))
	{
		gInput.captMagnOK = true;
	}
